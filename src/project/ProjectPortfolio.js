                        ...
                        <PrItemWrap className="contentTxt narr">
                            ...
                            <div className="pr_txt">
                                <div className="pr_outline">
                                    ...
                                    <p>
                                        지금까지 작업한 작업물들을 보여주기 위한 프로젝트입니다. 웹 사이트 디자인부터
                                        구성하고 구조를 계획하며 제가 원하는 UI를 구현한 프로젝트입니다.
                                    </p>
                                </div>
                                <div className="pr_explain">
                                    <p className="pr_head">기능</p>
                                    <p>스크롤 이동, 캐러셀, 반응형 웹</p>
                                </div>
                                <div className="pr_explain">
                                    <p className="pr_head">후기</p>
                                    <p>React를 이용하여 작업하며 반복되는 요소를 효율적으로 관리하려 노력했습니다.</p>
                                </div>
                            </div>
                        </PrItemWrap>
                        <div className="pr_photo wide">
                            <SlickSlider data={portfolioPhoto} />
                        </div>
                    </div>
