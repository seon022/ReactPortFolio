                        ...
                        <PrItemWrap className="contentTxt p3">
                            ...
                            <div className="pr_txt">
                                <div className="pr_outline">
                                    ...
                                    <p>
                                        울산 문화관광 웹사이트를 재구성하여 구현한 프로젝트입니다. 사용자의 수요를
                                        예상하여 주요 컨텐츠 위주로 웹페이지의 항목을 재구성하려 고민했습니다.
                                    </p>
                                </div>
                                <div className="pr_explain">
                                    <p className="pr_head">후기</p>
                                    <p>
                                        다른 지역의 관광 홈페이지를 참고하며, 사용자가 어떤 목적을 가지고 웹을
                                        접속했는지를 고민하여 배치를 설계했습니다. 그리고 아이콘을 이용한 퀵메뉴를
                                        만들어 사용성을 높이려 했습니다.
                                    </p>
                                </div>
                            </div>
